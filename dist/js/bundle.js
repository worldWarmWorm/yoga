...
function modal() {
  ...
  function getModalWindow(buttonMore, modalWindow, hide) {
    var more = document.querySelector(buttonMore),
  ...
  getModalWindow('.description-btn', '.overlay', '.popup-close'); //============================ MODAL WINDOWS ================================
}
...
function slider() {
  ...
  var slideIndex = 1,
      ...
      dots = document.querySelectorAll('.dot'); // showSlides(slideIndex);
...
function timer() {
  ...
  function setClock(id, endtime) {
    ...
    function updateClock() {
      var t = getTimeRemaining(endtime); // получаем разницу между дедлайном и сейчас
